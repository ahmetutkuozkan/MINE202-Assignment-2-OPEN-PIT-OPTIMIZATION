...
Table=excel_writer.Workbook("ECONOMIC BLOCK VALUES(Ore waster drawer with numbers).xlsx")
...
for j in range(11):
    for i in range(21):
        if(6<i<14 and 2<j):
            ...
            #print((cost_for_first_row+j*cost_for_row_increase+unit_ore_processing_cost)*Ton_for_ore,j+1,i+1)#Costs
